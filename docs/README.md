...
+ KWDB [(supplemental docs)](kwdb.md)
+ Akumuli [(supplemental docs)](akumuli.md)
+ Cassandra [(supplemental docs)](cassandra.md)
+ ClickHouse [(supplemental docs)](clickhouse.md)
+ CrateDB [(supplemental docs)](cratedb.md)
+ InfluxDB [(supplemental docs)](influx.md)
+ MongoDB [(supplemental docs)](mongo.md)
+ QuestDB [(supplemental docs)](questdb.md)
+ SiriDB [(supplemental docs)](siridb.md)
+ TimescaleDB [(supplemental docs)](timescaledb.md)
...
¹ Only cpu-only case are supported
...
$ go get gitee.com/kwdb/kwdb-tsbs
...
1. and which database(s) you want to generate for. E.g., `timescaledb`
 (choose from `kwdb`, `cassandra`, `clickhouse`, `cratedb`, `influx`, `mongo`, `questdb`, `siridb`,
...
For more details on how to use tsbs_load check out the [supplemental docs](tsbs_load.md)
